...
export default function Activities({ news }) {
  ...
  return (
    <div>
      ...
      <p class="text-right"><a href="#" class="ml-1 mt-1 text-sm leading-tight font-medium text-black hover:underline">ข่าวกิจกรรมทั้งหมด</a></p>
    </div>
  )
}
